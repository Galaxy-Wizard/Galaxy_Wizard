...
const DWORD King_Value = 7 * Pawn_Value;
const DWORD Queen_Value = 13 * Pawn_Value;
const DWORD Rook_Value = 7 * Pawn_Value;
const DWORD Bishop_Value = 4 * Pawn_Value;
const DWORD Knight_Value = 3 * Pawn_Value;
